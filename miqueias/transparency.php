...
<head>
    ...
    <title>Transparência - Portal do Associado</title>
...
<body class="bg-gray-50 dark:bg-gray-900">
    ...
    <div class="lg:ml-64">
        ...
        <main class="p-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                <!-- Charts -->
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 fade-in" style="animation-delay: 0.4s">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden fade-in" style="animation-delay: 0.6s">
                    ...
                    <table class="w-full text-left text-sm">
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                ...
                                <td class="px-6 py-4 text-gray-600 dark:text-gray-300">Manutenção Predial</td>
                                <td class="px-6 py-4 text-gray-500">Infraestrutura</td>
                                <td class="px-6 py-4 text-gray-900 dark:text-white font-medium text-right text-red-600">- R$ 1.250,00</td>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                ...
                                <td class="px-6 py-4 text-gray-600 dark:text-gray-300">Mensalidades Associados</td>
                                <td class="px-6 py-4 text-gray-500">Receitas</td>
                                <td class="px-6 py-4 text-gray-900 dark:text-white font-medium text-right text-green-600">+ R$ 15.400,00</td>
                                <td class="px-6 py-4 text-center">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                ...
                                <td class="px-6 py-4 text-gray-600 dark:text-gray-300">Material de Escritório</td>
                                <td class="px-6 py-4 text-gray-500">Administrativo</td>
    ...
    <script>
        ...
        new Chart(ctx, {
            type: 'doughnut',
            data: {
                labels: ['Eventos', 'Infraestrutura', 'Administrativo', 'Pessoal', 'Outros'],
                datasets: [{
                    data: [30, 25, 20, 15, 10],
                    backgroundColor: [
                        '#3b82f6', // Blue
